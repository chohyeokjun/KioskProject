...
public class Main {
    public static void main(String[] args) {
        ...
        pilates.addMenuItem(new MenuItem("신은주", "880,000원", "개인 레슨 10회"));
        pilates.addMenuItem(new MenuItem("신은주", "1,540,000원", "개인 레슨 20회"));
        pilates.addMenuItem(new MenuItem("신은주", "1,980,000원", "개인 레슨 30회"));
        pilates.addMenuItem(new MenuItem("진혜정", "850,000원", "개인 레슨 10회"));
        pilates.addMenuItem(new MenuItem("진혜정", "1,500,000원", "개인 레슨 20회"));
        pilates.addMenuItem(new MenuItem("진혜정", "1,770,000원", "개인 레슨 30회"));
        //Kiosk 객체 생성
